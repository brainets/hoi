...
.. glossary::
    ...
    Transfer Entropy
      Transfer entropy (TE) :cite:`schreiber2000measuring` is a directed measure of information flow between two time series. It quantifies how much the past of one variable helps predict the future of another variable, beyond what the variable's own past already explains.
