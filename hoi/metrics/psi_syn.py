...
class psi_synergy(HOIEstimator):
    r"""Integrated synergy (:math:`\psi`).

    For each couple of variable the synergy about their future is
    computed using the Minimum Mutual Information (MMI) approach:
    ...
    References
    ----------
    Mediano et al, 2018 :cite:`mediano2018measuring`
    """
